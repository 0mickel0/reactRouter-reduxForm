...
export const FETCH_UPLOAD_COVER_URL = "fetch_upload_cover_url";
export const POST_TO_UPLOAD_URL = "post_to_upload_url";
...
export const MODAL_TYPE_REDUX_FORM = 'MODAL_TYPE_REDUX_FORM';